    ...
    for (var item of shoesList) {
        ...
        if (j % 5 == 1) {
            ...
            $('#itemsContainer').append(
                ...
                '</button>' +
                '<img id="imageSrc' + itemId + '" src="' + imageSrc + '" alt="sneakers">' +
...
function showMoreDetailes(id) {
    ...
    if (!clickOnWishImg) {
        ...
        window.location.href = '../Shop/moreDetails.html?imageID=' + id + '&category=Sneakers';
    } else {
